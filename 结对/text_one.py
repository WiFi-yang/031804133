...
Path = 'C:/Users/Administrator/软工/imgs'
path = 'C:/Users/Administrator/软工/img/img.jpg'
# 一些常量
...
def main():
    ...
    save_path = "C:/Users/Administrator/软工/s/s.jpg"
    save_path1 = "C:/Users/Administrator/软工/s/f.jpg"
    gameImage = pygame.image.load(min_imgs(path, save_path))
    space = pygame.image.load(min_imgs(ergodic_file(), save_path1))
    ...
    pygame.display.flip()
    gameBoard, blackCell = newGameBoard(k)
    # 游戏主循环
    while True:
